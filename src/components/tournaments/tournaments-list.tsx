// src/components/tournaments/tournaments-list.tsx
'use client';
...
export default function TournamentsList({ tournaments }: { tournaments: Tournament[] }) {
  const router = useRouter();
  const { profile } = useAuth();
  const isOrganizer = profile?.role === 'organizer' || profile?.role === 'super_admin';
