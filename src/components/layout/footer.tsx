...
export default function Footer() {
  return (
    <footer className="w-full bg-card border-t border-border px-6 py-8 mt-auto pb-24 md:pb-8 text-sm">
      <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Brand Information */}
        <div className="space-y-4">
          <div>
            <span className="text-xl font-black tracking-wider text-primary">SHIVAY</span>
            <p className="text-xs text-muted-foreground uppercase font-semibold">The Cricketing Hub</p>
          </div>
          ...
          <div className="flex gap-4">
            <a 
              ...
              className="p-2 rounded-lg bg-input border border-border text-primary hover:bg-primary hover:text-background transition-colors"
            >
      ...
      <div className="max-w-4xl mx-auto border-t border-border mt-8 pt-6 text-center text-[10px] text-muted-foreground">
